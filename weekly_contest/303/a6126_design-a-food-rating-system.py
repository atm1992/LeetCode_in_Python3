...
class FoodRatings:
    ...
    def __init__(self, foods: List[str], cuisines: List[str], ratings: List[int]):
        ...
        for f, c, r in zip(foods, cuisines, ratings):
            self.f2cr[f] = (c, r)
            heapq.heappush(self.c2rf[c], (-r, f))

    def changeRating(self, food: str, newRating: int) -> None:
        c, r = self.f2cr[food]
        self.f2cr[food] = (c, newRating)
        heapq.heappush(self.c2rf[c], (-newRating, food))

    def highestRated(self, cuisine: str) -> str:
        while -self.c2rf[cuisine][0][0] != self.f2cr[self.c2rf[cuisine][0][1]][1]:
            heapq.heappop(self.c2rf[cuisine])
